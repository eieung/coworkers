...
const ImageUploader = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-900 p-6 text-white">
      <div className="p-4">
        {/* 게시물 제목 및 정보 */}
        <button className="btn123" onClick={handleSubmit}>
          등록
        </button>
      ...
      <div className="p-4">
        <div
          className="w-fulls mb-4 flex h-52 cursor-pointer flex-col items-center justify-center rounded-lg bg-gray-700 p-4 text-white"
