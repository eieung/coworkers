...
*/
 ...
 /* if (!post) {
  ...
  return (
    <div className="min-h-screen text-white p-6 bg-gray-900">   
      <div className="p-4">        
        <h1 className="text-2xl font-semibold mb-4">{title || "자유게시판에 질문을 올릴 수 있어요"}</h1>
        <hr style={{ border: 'none', height: '1px', backgroundColor: 'rgb(55 65 81 / var(--tw-bg-opacity))', margin: '20px 0' }} />
        <p className="text-sm text-gray-400 mb-4 flex items-center"><Image src={member} alt="member" width={32} height={32} />&nbsp;{userdata} | {datedata}&nbsp;&nbsp;&nbsp;<Image src={subtract} alt="subtract" width={16} height={16} style={{ float: 'right', marginLeft: 'auto' }} />{commentCount}&nbsp;<Image src={heart} alt="heart" width={16} height={16} />0</p>
        <p className="text-base leading-relaxed mb-6">{content || "본문이 들어가는 영역입니다.본문이 들어가는 영역입니다.본문이 들어가는 영역입니다.본문이 들어가는 영역입니다.본문이 들어가는 영역입니다.본문이 들어가는 영역입니다.본문이 들어가는 영역입니다.본문이 들어가는 영역입니다.본문이 들어가는 영역입니다.본문이 들어가는 영역입니다.본문이 들어가는 영역입니다."}</p>
      </div>
